...
void changeRule2(ruleSet_t *rules, int taille,
  ...
  case 0:
    change_case2(*rules, nb_rule, parameter, energy_multithreading, taille, bestRules);
    break;
  case 1:
    change_case2(*rules, nb_rule, parameter, energy_multithreading, taille, bestRules);
    break;
  ...
  case 3:
    ...
    break;
  case 4:
    change_direction_2(*rules, nb_rule, parameter, energy_multithreading, taille, bestRules);
    break;
  case 5:
    change_direction_2(*rules, nb_rule, parameter, energy_multithreading, taille, bestRules);
    break;
  case 6:
    change_distance_2(*rules, nb_rule, parameter, energy_multithreading, taille, bestRules);
    break;
  case 7:
    change_distance_2(*rules, nb_rule, parameter, energy_multithreading, taille, bestRules);
    break;
  case 8:
    change_action_2(*rules, nb_rule, parameter, energy_multithreading, taille, bestRules);
    break;
  case 9:
    change_priority_2(*rules, nb_rule, parameter, energy_multithreading, taille, bestRules);
    break;
  default:
    break;
  }
